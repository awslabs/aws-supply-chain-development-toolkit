...
# Input data location
data_path = input("Place all your data files in one folder, naming each after its entity. Then, input the folder's path, or press Enter to use the current directory: ") or "."
